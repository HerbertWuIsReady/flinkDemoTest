...
public abstract class BaseSender {
    ...
    public void sendMsg(final MsgOuterClass.Msg.Message message) {
...
*/
    ...
    protected void sendSucced(MsgOuterClass.Msg.Message message) {
        log.info("发送成功");

    }

    protected void sendfailed(MsgOuterClass.Msg.Message message) {
        log.info("发送失败");
    }
